...
def vit_base_14(patch_size=14, img_size=224, num_register_tokens=0, **kwargs):
    model = DinoVisionTransformer(
        img_size=img_size,
        patch_size=patch_size,
        embed_dim=768,
    ...
    state_dict = torch.load(r'D:\PhD\Year1\Projects\Training_strategies\dinov2_base.pth', weights_only=False)
