...
def parse_args_SiT():
    ...
    argparser.add_argument('--vae', type=str, default='SD2', help='VAE model to use (e.g. SD2)', choices=['SD2', 'SD3', 'Flux1', 'Flux2'])
...
def parse_args_iREPA():
    ...
    argparser.add_argument("--projection_loss_type", type=str, default="cosine", help="Should be a comma-separated list of projection loss types")
    ...
    argparser.add_argument("--feature_extractor", action='store_true', default=False, help='Extract features with the SiT encoder')
    return argparser.parse_args()